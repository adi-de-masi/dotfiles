...
map("n", "<leader>bdh", "<CMD>lua require('nvchad.tabufline').closeBufs_at_direction('left')<CR>")
map("n", "<leader>bdl", "<CMD>lua require('nvchad.tabufline').closeBufs_at_direction('right')<CR>")
